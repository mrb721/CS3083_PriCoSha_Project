...
/*
	...
	2. Makes a request to delete a given friend group.append
		2.1 Note that this deletes all of the member rows and shares associated with this friend group.
*/
...
func main() {
	...
	// SEND A REQUEST TO DELETE A FRIEND GROUP
	...
	fmt.Println("Response to delete friend group request: ", string(bdy))
}
